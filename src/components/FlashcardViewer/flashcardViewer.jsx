    ...
    return(
        <div className="flashcard-viewer">
            <div className="previous-flashcard">
                <button id="previousButton" onClick={() => props.previousFlashcard()}><i class="fas fa-angle-double-left fa-7x"></i></button>
            </div>
            ...
            <div className="next-flashcard">
                ...
                <button id="nextButton" onClick={() => props.nextFlashcard()}><i class="fas fa-angle-double-right fa-7x"></i></button>
            </div>
        </div>
    )
}
